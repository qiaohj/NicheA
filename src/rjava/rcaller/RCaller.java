...
import rjava.graphics.GraphicsTheme;
import rjava.rcaller.exception.RCallerExecutionException;
...
//    rcode.addRCode("}\n");
  ...
  public File createRSourceFile() throws RCallerExecutionException {
    File f = null;
  ...
  public void runOnly() throws RCallerExecutionException {
    ...
    try {
      ...
      while ( (line = br.readLine()) != null)
		{
			returnval.append(line + Const.LineBreak);
		}
      process.waitFor();
  ...
  public void runAndReturnResultOnline(String var) throws RCallerExecutionException {
  ...
  public void runAndReturnResult(String var) throws RCallerExecutionException {
    String commandline = null;
    String result = null;
...
//      System.out.println(commandline);
  ...
  public void R_source(String sourceFile) {
	...
	public void checkLibrary(String library) {
		rcode.clear();
	    rcode.addRCode("packageExist<-require(" + library + ")");
	    rcode.addRCode("if(!packageExist){");
	    rcode.addRCode("install.packages(\"" + library + "\")");
	    rcode.addRCode("}\n");
	    System.out.println(rcode.toString());
		runOnly();
	}
